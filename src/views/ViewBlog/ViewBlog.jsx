      ...
      <div className="w-100 main d-flex global-layout">
        ...
        >
          ...
          <div className={`RightNav`}>
            <div
              className="view-blog-filter-tab"
            ...
            >
              ...
              <div className="filter-dropdown-menu">
                ...
                >
                  ...
                  <Dropdown.Item id="dropdown-menu-align-left" eventKey="PUBLISH">
                    Publish
                  </Dropdown.Item>
                  <Dropdown.Item id="dropdown-menu-align-left" eventKey="DRAFT">
                    Draft
                  </Dropdown.Item>
                </DropdownButton>
                <DropdownButton
                ...
                >
                  ...
                  <Dropdown.Item id="dropdown-menu-align-left" eventKey="News">
                    News
                  </Dropdown.Item>
                  <Dropdown.Item id="dropdown-menu-align-left" eventKey="Feeds">
                    Feeds
                  </Dropdown.Item>
                  <Dropdown.Item
                    id="dropdown-menu-align-left"
                            ...
                            <div className="text-body">
                              ...
                              <div className="keyword-container">
                                {data?.key?.slice(0, 5).map((item, index) => {
                                  return (
                                    <p className="keyword shadow-sm">
                                      {item?.text}
                                    </p>
                                  );
                                })}
                              </div>
                              <p className="card-feeds">
                                {" "}
                                In {data?.dropdownValue} Category
                              </p>
                            </div>
                          </Link>
